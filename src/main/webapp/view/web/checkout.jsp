...
<section class="myAcc myAcc2">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <h3 style="margin-bottom: 30px;text-align: left">Địa chỉ giao hàng</h3>
                ...
                <div class="accInput">
                    <p>Họ và tên</p>
                    <input type="text" class="inputText" placeholder="Họ và tên ">
                </div>
                <div class="accInput">
                    <p>Thành phố</p>
                ...
                <div class="accInput">
                    <p>Địa chỉ </p>
                    <input type="text" class="inputText" placeholder="Địa chỉ">
                </div>
                <div class="accInput">
                    <p>Số điện thoại </p>
                    <input type="text" class="inputText" placeholder="Số điện thoại">
                </div>
            ...
            <div class="col-md-4">
                <div class="form-tax">
                    ...
                    <div class="box-formTax-count">
                        <div class="row">
                            <div class="col-md-6">Gía tiền:</div>
                    ...
                    <div class="box-formTax-total">
                        <div class="row">
                            ...
                            <div class="col-md-6 last-price" style="text-align: right;font-size: 18px;font-weight: bold">$11,000
                            </div>
                        </div>
                    </div>
